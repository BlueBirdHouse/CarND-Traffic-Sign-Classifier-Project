...
def SoftMaxOutPut(DataBase_X,DataBase_y,sess):
    '''
    输出网络对外部数据的SoftMax响应
    '''
...
with open(pickle_file, 'rb') as f:
  ...
  X_OutSidetest_Matlab = pickle_data['X_OutSidetest_Matlab']
  y_OutSidetest_Matlab = pickle_data['y_OutSidetest_Matlab']
...
#%%计算平均SoftMax值的过程
TotalSoftMax = SoftMaxOutPut(X_OutSidetest_Matlab,y_OutSidetest_Matlab,sess)
